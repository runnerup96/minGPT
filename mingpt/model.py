...
class SelfAttention(nn.Module):
    """
    Multi-head self-attention. When is_causal=True (default), a triangular mask ensures
    each position only attends to previous positions (decoder behaviour). When
    is_causal=False, attention is bidirectional (encoder behaviour).
    """
